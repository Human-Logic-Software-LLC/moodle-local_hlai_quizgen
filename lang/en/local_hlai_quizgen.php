...
$string['privacy:metadata:local_hlai_quizgen_qst_history'] = 'Stores question edit history';
$string['privacy:metadata:local_hlai_quizgen_qst_history:timecreated'] = 'The time when the edit was made';
$string['privacy:metadata:local_hlai_quizgen_qst_history:userid'] = 'The ID of the user who edited the question';
$string['privacy:metadata:local_hlai_quizgen_ratelimit_log'] = 'Tracks API rate limiting per user';
$string['privacy:metadata:local_hlai_quizgen_ratelimit_log:timecreated'] = 'The time of the rate limit event';
$string['privacy:metadata:local_hlai_quizgen_ratelimit_log:userid'] = 'The ID of the rate-limited user';
$string['privacy:metadata:local_hlai_quizgen_refine_suggest'] = 'Stores AI refinement suggestions for questions';
$string['privacy:metadata:local_hlai_quizgen_refine_suggest:timecreated'] = 'The time when the suggestion was created';
$string['privacy:metadata:local_hlai_quizgen_refine_suggest:userid'] = 'The ID of the user who triggered the suggestion';
$string['privacy:metadata:local_hlai_quizgen_refinements'] = 'Stores AI refinement actions on questions';
$string['privacy:metadata:local_hlai_quizgen_refinements:timecreated'] = 'The time when the refinement was performed';
$string['privacy:metadata:local_hlai_quizgen_refinements:userid'] = 'The ID of the user who performed the refinement';
...
$string['privacy:metadata:local_hlai_quizgen_review_comments'] = 'Stores comments made during peer review';
$string['privacy:metadata:local_hlai_quizgen_review_comments:timecreated'] = 'The time when the comment was posted';
$string['privacy:metadata:local_hlai_quizgen_review_comments:userid'] = 'The ID of the user who posted the comment';
$string['privacy:metadata:local_hlai_quizgen_review_log'] = 'Stores review activity log entries';
$string['privacy:metadata:local_hlai_quizgen_review_log:timecreated'] = 'The time of the review activity';
$string['privacy:metadata:local_hlai_quizgen_review_log:userid'] = 'The ID of the user whose activity was logged';
$string['privacy:metadata:local_hlai_quizgen_review_ratings'] = 'Stores quality ratings given during review';
$string['privacy:metadata:local_hlai_quizgen_review_ratings:timecreated'] = 'The time when the rating was given';
$string['privacy:metadata:local_hlai_quizgen_review_ratings:userid'] = 'The ID of the user who gave the rating';
...
$string['privacy:metadata:local_hlai_quizgen_wizard_state'] = 'Stores wizard session state for resumption';
$string['privacy:metadata:local_hlai_quizgen_wizard_state:timecreated'] = 'The time when the state was saved';
$string['privacy:metadata:local_hlai_quizgen_wizard_state:userid'] = 'The ID of the user';
